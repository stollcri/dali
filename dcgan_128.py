...
class DeepConvolutionalGenerativeAdversarialNetwork(object):
    ...
    def make_generator_model(self):
        ...
        x = layers.Reshape((16, 16, 128), input_shape=(16 * 16 * 128,))(x)
        ...
        #=> 64 * 64 * 8 = 32,768
        x = layers.Conv2DTranspose(8, 5, strides=(2, 2), activation="relu", padding="same", use_bias=False)(x)
        x = layers.BatchNormalization()(x)
...
#         return gp
    ...
    def train_step(self, images, gradient_penalty_weight=2.0):
